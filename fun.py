    ...
    async def cc(self,ctx:Context,name:str=" ",*description):
        if name.startswith("<@"):
            ...
            if r:
                ...
                # print(r)
                # print("====================")
                myEmbed = discord.Embed(name=f"Commands Created By {name}",description=f"{name} has created{len(r)+1} Commands ")
                for i in r:
                    # print("====================")
                    # print("i=")
                    # print(i)
                ...
                myEmbed = discord.Embed(name=f"Commands Created By {name}",description=f"{name} has not created any Commands")
        if name == " ":
